    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5"
                src="https://cdn.discordapp.com/attachments/893701267539497011/907477773273145434/iconBiLocker-baru.png"
                alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">BiLocker</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Your Locker Solution in Hand</p>
        </div>
    </header>
    <!-- Portfolio Section-->
