        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 mb-5"
                ...
                <div class="contact-item mx-auto">
                    ...
                    <img class="img-fluid"
                        src="https://cdn.discordapp.com/attachments/895156326865444904/923473257301151754/instagram.png"
                        alt="..." />
                </div>
            </div>
            <!-- Social Item 2-->
            <div class="col-md-6 col-lg-4 mb-5"
                ...
                <div class="contact-item mx-auto">
                    ...
                    <img class="img-fluid"
                        src="https://cdn.discordapp.com/attachments/895156326865444904/923473460523573269/facebook.png"
                        alt="..." />
                </div>
            </div>
            <!-- Social Item 3-->
            <div class="col-md-6 col-lg-4 mb-5"
                ...
                <div class="contact-item mx-auto">
                    ...
                    <img class="img-fluid"
                        src="https://cdn.discordapp.com/attachments/895156326865444904/923473275697389568/youtube.png"
                        alt="..." />
                </div>
            </div>
        </div>
